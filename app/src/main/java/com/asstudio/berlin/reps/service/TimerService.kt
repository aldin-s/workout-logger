...
class TimerService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        try {
            ...
            android.util.Log.e("TimerService", "Error in onStartCommand", e)
    ...
    private fun startForegroundService() {
        try {
            ...
            android.util.Log.e("TimerService", "SecurityException starting foreground", e)
    ...
    companion object {
        ...
        const val ACTION_START_TIMER = "com.asstudio.berlin.reps.ACTION_START_TIMER"
        const val ACTION_STOP_TIMER = "com.asstudio.berlin.reps.ACTION_STOP_TIMER"
